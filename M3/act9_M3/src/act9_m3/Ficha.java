 ...
 * Author: Aitor Pumar
 * Date: 28-10-2020
 * Description: Clase que se encarga de comprobar que las fichas hagan movimientos correctos
 */
package act9_m3;
...
public class Ficha {
    ...
    private int columna;
    private String tipo;
    private boolean blanca; // true -> blanca, false -> negra

    // CONSTRUCTORES
    public Ficha(int fila, int columna, javax.swing.JTable tablero, boolean turno){
        this.fila = fila;
    ...
    // METODO QUE COMPRUEBA SI UNA FICHA ES DEL COLOR DE SU TURNO
     ...
     */
    public boolean movimientoValido(Ficha fichaDestino, javax.swing.JTable tablero){
    ...
    private boolean isPeonValido(Ficha destino, javax.swing.JTable tablero) {
    ...
    private boolean peonAvanzaUno(Ficha destino){
    ...
    private boolean isTorreValida(Ficha destino, javax.swing.JTable tablero) {
    ...
    private boolean isAlfilValido(Ficha destino, javax.swing.JTable tablero) {
    ...
    private boolean colisiona(Ficha destino, javax.swing.JTable tablero){
    ...
    private int[] calculaVector(Ficha destino) {
